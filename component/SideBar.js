    ...
    <div className="" id="outer-container">
      ...
      >
        <div className="flex flex-col ">
          <div className='p-4'>
            <img src="https://i.ibb.co/pZGLfmF/shanta-logo.png" alt="Imge" />
          </div>

          <div>
            <div className="bg-subTile w-3/4 rounded-tr-lg mb-1">
              <h2 className="text-white md:text-lg font-bold pl-2">Cushion</h2>
            </div>
                ...
                return (
                  <>
                    <div
                      key={i}
                      onClick={handleClick}
                      className="border-4 border-borderColor rounded"
                    >
            ...
            <p className="text-sm font-bold text-white text-center mb-2 cursor-pointer">
              See more
            </p>
          </div>
          <div>
        ...
        //   onClose={handleOnClose}
          ...
          className="py-2 bg-zinc-600 absolute bottom-0 w-full rounded-bl-lg "
        >
